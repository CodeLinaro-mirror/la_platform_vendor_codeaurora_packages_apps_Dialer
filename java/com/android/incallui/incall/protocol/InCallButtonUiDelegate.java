...
public interface InCallButtonUiDelegate {
  ...
  default void satelliteAvailabilityButtonClicked(boolean checked) {}

  default void onLaunchSatelliteAppButtonClicked() {}

  default void onRttToVideoClicked() {}

  default void downgradeToVoice() {}

  default void downgradeToRtt() {}

  default void downgradeToVideo() {}

  default void downgradeCall() {}
